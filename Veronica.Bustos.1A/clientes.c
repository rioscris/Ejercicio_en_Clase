    ...
    if(lista !=  NULL)
    {
        if(lugarLibre != -1)
        {
            ...
            do
            {
                ...
                scanf("%c", &auxiliarSexo);

            }
            while(auxiliarSexo != 'm' && auxiliarSexo != 'M' && auxiliarSexo != 'f' && auxiliarSexo != 'F');


            printf("Ingrese direccion: ");
            fflush(stdin);
            gets(auxiliarCliente.domicilio);
...
int removerCliente(eCliente* lista, int len, int id)
{
    ...
    if(lista!=NULL)
    {
        printf("Ingrese el id del cliente que desa eliminar: ");
        scanf("%d",&id);
        ...
        if(index >= 0)
        {
            do
            {
                ...
                case 3:
                    ...
                    while(nuevoSexo != 'm' && nuevoSexo != 'M' && nuevoSexo != 'f' && nuevoSexo != 'F');
